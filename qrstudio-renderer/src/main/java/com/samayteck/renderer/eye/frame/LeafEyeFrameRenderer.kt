...
internal object LeafEyeFrameRenderer : EyeFrameRenderer {
    ...
    override fun draw(
        ...
        val radii = floatArrayOf(radius, radius, 0f, 0f, radius, radius, 0f, 0f)
        path.addRoundRect(rect, radii, Path.Direction.CW)
        canvas.drawPath(path, paint)
        
        // Inner leaf (5 modules)
        ...
        val innerRadii = floatArrayOf(innerRadius, innerRadius, 0f, 0f, innerRadius, innerRadius, 0f, 0f)
